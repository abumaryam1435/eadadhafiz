...
const newTabs = `
      <div className="flex bg-gray-100 dark:bg-slate-800 p-1 rounded-2xl mb-3 border border-gray-200 dark:border-slate-700 shadow-sm flex-wrap">
        <button
          onClick={() => setActiveTab('add')}
          className={\`flex-1 py-2.5 text-center rounded-xl font-black text-xs sm:text-sm transition-all \${
            activeTab === 'add'
