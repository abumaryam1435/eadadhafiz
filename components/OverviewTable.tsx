...
export const OverviewTable: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white p-3.5 sm:p-6 lg:p-8 rounded-2xl shadow-lg dark:bg-gray-800 animate-fade-in">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 border-b dark:border-gray-700 pb-4">
          <div>
            <h3 className="text-xl sm:text-2xl font-black text-green-900 dark:text-green-300">
              نظرة عامة على بيانات الطلاب
            </h3>
            <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mt-0.5">
              عرض وتصفية وتصدير كافة بيانات وحفظ الطلاب
            </p>
          </div>
          <div className="px-3 py-1.5 sm:px-4 sm:py-2 bg-green-50 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded-xl font-black shadow-xs text-xs sm:text-sm border border-green-100 dark:border-green-800 shrink-0 self-start sm:self-auto">
            عدد السجلات: {filteredAndSortedData.length}
          </div>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 mt-4 sm:mt-6 mb-4 no-print">
          <FilterItem
            id="student"
            title="الطالب"
        ...
        <div className="mb-4 no-print mt-4 border-t dark:border-gray-700 pt-4 sm:pt-5 space-y-3">
          <div className="w-full relative">
            <label
              htmlFor="search-overview"
              className="block text-xs sm:text-sm font-bold text-gray-700 mb-1 dark:text-gray-200"
            >
            ...
            <div className="relative flex items-center">
              <input
                ...
                className="input-style w-full pl-10 pr-4 text-xs sm:text-sm h-10 sm:h-11"
              />
              <svg
          ...
          {/* شريط أزرار التصدير والعمليات بتنسيق متجاوب بالكامل يناسب شاشات الهواتف */}
