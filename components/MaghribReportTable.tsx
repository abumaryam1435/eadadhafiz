  ...
  return (
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg dark:bg-gray-800 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-4 mb-6 no-print">
       ...
       <div className="flex flex-wrap items-center gap-2 mb-6 no-print justify-start border-t border-gray-100 dark:border-gray-700 pt-5">
          <button onClick={() => setIsExcelModalOpen(true)} className="px-3 py-2 text-[10px] font-bold text-white bg-green-600 rounded-lg shadow-sm active:scale-95">Excel</button>
          <button onClick={() => setIsWordModalOpen(true)} className="px-3 py-2 text-[10px] font-bold text-white bg-blue-600 rounded-lg shadow-sm active:scale-95">Word</button>
          <div className="flex gap-1">
             <button onClick={() => exportToPdf(headers, filteredAndSortedData, exportPrefix, exportTitle, undefined, hijriAdjustments)} className="px-3 py-2 text-[10px] font-bold text-white bg-red-600 rounded-lg shadow-sm active:scale-95 flex items-center gap-1">
             ...
             <button onClick={() => sharePdfDirectly(headers, filteredAndSortedData, exportPrefix, exportTitle, undefined, hijriAdjustments, undefined, undefined, "landscape")} className="px-3 py-2 text-[10px] font-bold text-white bg-green-600 hover:bg-green-700 rounded-lg shadow-sm active:scale-95 flex items-center gap-1">
